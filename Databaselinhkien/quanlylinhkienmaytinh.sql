...
INSERT INTO `donhang` VALUES (1,1,2,5,'2021-11-05 00:00:00','2021-01-01 00:00:00',NULL,'Lucy','091231','32/52 khánh Hội','Nữ',NULL,'Giao buổi sáng',NULL,NULL,NULL,NULL,NULL,''),(2,1,2,NULL,'2021-11-05 00:00:00','2021-01-01 00:00:00',NULL,'Khang','0891214','12/23 Chi phương','Nam',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'');
...
INSERT INTO `sanpham` VALUES (1,1,1,'(8GB DDR4 1x8GB 3200) RAM Laptop Samsung 8GB 3200 CL22 SODIMM','Thiết kế cổ điển, hiệu năng ấn tượng\nThiết kế cổ điển với hiệu năng cao và chế tạo bằng các thành phần chất lượng. Ram laptop Samsung mang lại hiệu quả sử dụng cao dành cho công việc hàng ngày của bạn.\nMột hệ thống tối ưu là một hệ thống vận hành mượt mà và ổn định. Nhà sản xuất cung cấp một bus ram cao lên đến 3200Mhz đem lại hiệu quả sử dụng rất tốt. Các tác vụ sử dụng một cách mượt mà với độ trễ thấp và tính ổn định lâu dài.',1450000,1150000,36,NULL,NULL,50,NULL,NULL,'còn'),(2,2,1,'(16GB DDR4 1x16GB 3200) RAM Laptop Team Group 16GB 3200 SODIMM','Dễ dàng lắp đặt và nâng cấp',2190000,2190000,36,NULL,NULL,50,NULL,NULL,'còn'),(3,2,1,'(8GB DDR4 1x8GB 3200) RAM TeamGroup T-Force Delta RGB White','Hiệu năng ấn tượng, tốc độ cao',1190000,1100000,60,NULL,NULL,50,NULL,NULL,'còn'),(4,2,1,'(8GB DDR4 1x8GB 3200) RAM TeamGroup T-Force Delta RGB Black','Hiệu năng ấn tượng, tốc độ cao',1190000,1100000,60,NULL,NULL,50,NULL,NULL,'còn'),(5,5,2,'Bàn phím Leopold FC660MPD Light Pink','Keycap PBT Doubleshot\nVới chất liệu nhựa keycap PBT Doubleshot dày 1.5mm cao cấp nhất hiện nay góp phần tăng cảm giác thoải mái khi gõ phím cùng với chất lượng không hao mòn bởi thời gian.\nĐộ ổn định cao cấp với khung CHERRY Stabilizer\nVới các phím Shift, Spacebar, Enter và Backspace sẽ luôn luôn ở trạng thái cân bằng cho dù bạn có ấn ở góc độ nào đi chăng nữa. Với khung trục ổn định không hề bị ảnh hưởng bởi thời gian. Chắc chắn sẽ cực kì hữu dụng!',2750000,2700000,24,NULL,NULL,NULL,NULL,NULL,'Mới 100%');
...
INSERT INTO `thuonghieu` VALUES (1,'Samsung'),(2,'TeamGroup'),(3,'Corsair'),(4,'Logitech'),(5,'Leopold ');
...
-- Dump completed on 2021-11-15 10:42:33
